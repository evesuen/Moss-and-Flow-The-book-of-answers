import { imgGroup4044, imgAskTheCards, imgIndicator, imgIndicator1, imgHandle, imgShape13, imgShape14, imgShape15, imgShape16, imgOthersThinkingProblem } from "./svg-yszlv";
