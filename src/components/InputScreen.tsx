...
export function InputScreen({ onQuestionSubmit }: InputScreenProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-4xl h-full justify-center">
      ...
      {/* Input Section */}
      <div className="bg-card border border-border rounded-[8px] p-4 w-full max-w-[600px] shadow-[0px_1px_7.3px_2px_rgba(67,137,114,0.2)] hover:border-[hsla(160,34%,30%,1)] focus-within:border-[hsla(160,34%,30%,1)] transition-colors">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex gap-2">
              ...
              >
                ...
                <span className="text-[14px] font-['Playfair_Display',serif] font-extrabold font-[Playfair]">随机问题</span>
              </button>
              ...
              >
                ...
                <span className="text-[14px] font-['Playfair_Display',serif] font-extrabold font-[Playfair]">今日牌卡</span>
              </button>
            </div>
