...
const todayQuestions = ["今日的关键讯息是什么？", "今天的幸运来自哪里？", "今天我该用什么态度去迎接生活？"];
					...
					<div className='flex items-center justify-between gap-2'>
						<div className='flex gap-2'>
							<button
								...
								<span className='text-[14px] font-chinese font-extrabold font-chinese'>随机问题</span>
							</button>
							...
							<button
								...
								<span className='text-[14px] font-chinese font-extrabold font-chinese'>今日牌卡</span>
							</button>
						</div>
